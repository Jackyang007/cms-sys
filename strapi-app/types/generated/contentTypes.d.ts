...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Mini program activity configuration.';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctas: Schema.Attribute.Component<'ui.cta', false>;
    currentOrderCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    detailImages: Schema.Attribute.Component<'ui.image-item', true>;
    ...
    meta_version: Schema.Attribute.String;
    minDiscountCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<30>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMerchantMerchant extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Merchant / dealer basic information.';
